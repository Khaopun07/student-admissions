...
-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('PENDING_REVIEW', 'DOCUMENTS_SUBMITTED', 'ELIGIBLE_FOR_EXAM', 'ADMISSION_ANNOUNCED', 'CONFIRMED_ADMISSION', 'REJECTED_ADMISSION', 'NOT_PROCESSED', 'WAITING_FOR_CALL');

-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('EXAM_CONFIRMATION_1', 'EXAM_CONFIRMATION_2', 'PAYMENT_SLIP', 'ADMISSION_CONFIRMATION_1', 'ADMISSION_CONFIRMATION_2', 'ADMISSION_CONFIRMATION_3', 'ADMISSION_CONFIRMATION_4');
