    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Support */}
          <div>
            <h3 className="text-lg font-bold mb-4">ช่วยเหลือ</h3>
            <ul className="space-y-2 text-sm text-gray-300">
              <li>
                <Link href="/help">
                  <span className="hover:text-white cursor-pointer">คู่มือการใช้งาน</span>
                </Link>
              </li>
              <li>
                <Link href="/faq">
                  <span className="hover:text-white cursor-pointer">คำถามที่พบบ่อย</span>
                </Link>
              </li>
              <li>
                <Link href="/contact">
                  <span className="hover:text-white cursor-pointer">ติดต่อสอบถาม</span>
                </Link>
              </li>
              <li>
                <Link href="/privacy">
